        ...
        <div class="navbar-header">
                        ...
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="notification-list">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        <img src="<?= base_url('dist/') ?>assets/images/users/avatar-2.jpg"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        <img src="<?= base_url('dist/') ?>assets/images/users/avatar-3.jpg"
                                            class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        <img src="<?= base_url('dist/') ?>assets/images/users/avatar-5.jpg"
                                            class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="flex-grow-1">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-1 header-item d-none d-sm-flex">
                    <a href="<?= base_url('/admin/auth/signout'); ?>" class="btn btn-icon btn-topbar material-shadow-none btn-ghost-secondary rounded-circle" title="Keluar">
                    Keluar <i class='mdi mdi-logout fs-22'></i>
                    </a>
                </div>
                    ...
                    <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user"
                                src="<?= base_url('dist/') ?>assets/images/users/avatar-1.jpg" alt="Header Avatar">
