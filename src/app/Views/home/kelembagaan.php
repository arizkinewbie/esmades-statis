<!-- Sample Modal -->
<div class="modal fade flip modalFullScreen" id="bpdModal" tabindex="-1" aria-labelledby="modalFullScreenLabel" aria-hidden="true">
                  ...
                  <div class="col-md-6"> <!-- Sesuaikan ukuran kolom dengan kebutuhan -->
                     <div class="row">
                        <div class="col-md-4 text-center mb-4">
                           <a href="#" data-bs-toggle="modal" data-bs-target="#bpdModal"> <!--Ganti pada data-bs-target sesuaikan dengan id modal yang ingin dipanggil -->
                              <div class="profile-user position-relative d-inline-block mx-auto mb-2 mt-3">
                                 <img src="<?= base_url('dist/') ?>assets/images/lembaga/bpd.png" alt="" class="avatar-sm material-shadow">
                              </div>
                              <h5 class="fs-14 mb-1">BPD</h5>
                        ...
                        <div class="col-md-4 text-center mb-4">
                           <a href="#" data-bs-toggle="modal" data-bs-target="#modalSample2"> <!--Ganti pada data-bs-target sesuaikan dengan id modal yang ingin dipanggil -->
                              <div class="profile-user position-relative d-inline-block mx-auto mb-2 mt-3">
                                 <img src="<?= base_url('dist/') ?>assets/images/lembaga/lpm.png" alt="" class="avatar-sm material-shadow">
                              </div>
                              <h5 class="fs-14 mb-1">LPM</h5>
