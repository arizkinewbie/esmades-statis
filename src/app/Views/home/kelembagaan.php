<div class="main-content">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header align-items-center">
                    <h2 class="">Kelembagaan</h2>
                    <p class="mb-0">Informasi tentang struktur kelembagaan desa.</p>
                </div><!-- end card header -->
                <div class="card-body">
    ...
    <div class="modal fade flip modalFullScreen" tabindex="-1" aria-labelledby="modalFullScreenLabel"
        aria-hidden="true">
