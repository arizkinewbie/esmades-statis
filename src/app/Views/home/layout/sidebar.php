    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?= base_url('lahan-desa') ?>" role="button"
                        aria-expanded="false" aria-controls="sidebarLayouts">
                        <i class="ri-flood-line"></i> <span data-key="t-layouts">Penggunaan Lahan Desa</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?= base_url('sapras-desa') ?>" role="button"
                        aria-expanded="false" aria-controls="sidebarLayouts">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?= base_url('kependudukan') ?>" role="button"
                        aria-expanded="false" aria-controls="sidebarLayouts">
                        <i class="ri-map-pin-user-line"></i> <span data-key="t-layouts">Sebaran Penduduk</span> <span
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?= base_url('peraturan-desa') ?>" role="button"
                        aria-expanded="false" aria-controls="sidebarLayouts">
